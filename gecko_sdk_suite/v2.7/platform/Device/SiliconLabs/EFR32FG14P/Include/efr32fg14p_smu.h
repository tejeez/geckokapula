/***************************************************************************//**
 * @file
 * @brief EFR32FG14P_SMU register and bit field definitions
 *******************************************************************************
 * # License
 ...
 ******************************************************************************/
/***************************************************************************//**
 * @defgroup EFR32FG14P_SMU SMU
 * @{
 * @brief EFR32FG14P_SMU Register Declaration
 ******************************************************************************/
...
/***************************************************************************//**
 * @addtogroup EFR32FG14P_SMU
 * @{
 * @defgroup EFR32FG14P_SMU_BitFields  SMU Bit Fields
 * @{
 ******************************************************************************/
...
#define _SMU_PPUPATD0_MASK                 0xE37FDFA7UL                           /**< Mask for SMU_PPUPATD0 */
...
#define SMU_PPUPATD0_VDAC0                 (0x1UL << 9)                           /**< Digital to Analog Converter 0 access control bit */
#define _SMU_PPUPATD0_VDAC0_SHIFT          9                                      /**< Shift value for SMU_VDAC0 */
#define _SMU_PPUPATD0_VDAC0_MASK           0x200UL                                /**< Bit mask for SMU_VDAC0 */
#define _SMU_PPUPATD0_VDAC0_DEFAULT        0x00000000UL                           /**< Mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_VDAC0_DEFAULT         (_SMU_PPUPATD0_VDAC0_DEFAULT << 9)     /**< Shifted mode DEFAULT for SMU_PPUPATD0 */
...
#define SMU_PPUPATD0_IDAC0                 (0x1UL << 17)                          /**< Current Digital to Analog Converter 0 access control bit */
#define _SMU_PPUPATD0_IDAC0_SHIFT          17                                     /**< Shift value for SMU_IDAC0 */
#define _SMU_PPUPATD0_IDAC0_MASK           0x20000UL                              /**< Bit mask for SMU_IDAC0 */
#define _SMU_PPUPATD0_IDAC0_DEFAULT        0x00000000UL                           /**< Mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_IDAC0_DEFAULT         (_SMU_PPUPATD0_IDAC0_DEFAULT << 17)    /**< Shifted mode DEFAULT for SMU_PPUPATD0 */
...
#define SMU_PPUPATD0_LESENSE               (0x1UL << 20)                          /**< Low Energy Sensor Interface access control bit */
#define _SMU_PPUPATD0_LESENSE_SHIFT        20                                     /**< Shift value for SMU_LESENSE */
#define _SMU_PPUPATD0_LESENSE_MASK         0x100000UL                             /**< Bit mask for SMU_LESENSE */
#define _SMU_PPUPATD0_LESENSE_DEFAULT      0x00000000UL                           /**< Mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_LESENSE_DEFAULT       (_SMU_PPUPATD0_LESENSE_DEFAULT << 20)  /**< Shifted mode DEFAULT for SMU_PPUPATD0 */
...
#define SMU_PPUPATD0_PCNT0                 (0x1UL << 24)                          /**< Pulse Counter 0 access control bit */
#define _SMU_PPUPATD0_PCNT0_SHIFT          24                                     /**< Shift value for SMU_PCNT0 */
#define _SMU_PPUPATD0_PCNT0_MASK           0x1000000UL                            /**< Bit mask for SMU_PCNT0 */
#define _SMU_PPUPATD0_PCNT0_DEFAULT        0x00000000UL                           /**< Mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_PCNT0_DEFAULT         (_SMU_PPUPATD0_PCNT0_DEFAULT << 24)    /**< Shifted mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_PRORTC                (0x1UL << 25)                          /**< Protocol Real-Time Counter access control bit */
#define _SMU_PPUPATD0_PRORTC_SHIFT         25                                     /**< Shift value for SMU_PRORTC */
#define _SMU_PPUPATD0_PRORTC_MASK          0x2000000UL                            /**< Bit mask for SMU_PRORTC */
#define _SMU_PPUPATD0_PRORTC_DEFAULT       0x00000000UL                           /**< Mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_PRORTC_DEFAULT        (_SMU_PPUPATD0_PRORTC_DEFAULT << 25)   /**< Shifted mode DEFAULT for SMU_PPUPATD0 */
...
#define _SMU_PPUFS_PERIPHID_VDAC0          0x00000009UL                         /**< Mode VDAC0 for SMU_PPUFS */
...
#define _SMU_PPUFS_PERIPHID_IDAC0          0x00000011UL                         /**< Mode IDAC0 for SMU_PPUFS */
...
#define _SMU_PPUFS_PERIPHID_LESENSE        0x00000014UL                         /**< Mode LESENSE for SMU_PPUFS */
...
#define _SMU_PPUFS_PERIPHID_PCNT0          0x00000018UL                         /**< Mode PCNT0 for SMU_PPUFS */
#define _SMU_PPUFS_PERIPHID_PRORTC         0x00000019UL                         /**< Mode PRORTC for SMU_PPUFS */
