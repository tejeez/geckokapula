...
#ifndef EFR32FG14P232F128GM48_H
#define EFR32FG14P232F128GM48_H
...
/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48 EFR32FG14P232F128GM48
 * @{
 ******************************************************************************/
...
/******  EFR32FG14P Peripheral Interrupt Numbers ********************************************/
  ...
  VDAC0_IRQn            = 38, /*!< 16+38 EFR32 VDAC0 Interrupt */
  LESENSE_IRQn          = 39, /*!< 16+39 EFR32 LESENSE Interrupt */
  TRNG0_IRQn            = 40, /*!< 16+40 EFR32 TRNG0 Interrupt */
} IRQn_Type;

#define CRYPTO_IRQn               CRYPTO0_IRQn /*!< Alias for CRYPTO0_IRQn */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_Core Core
 * @{
...
/** @} End of group EFR32FG14P232F128GM48_Core */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_Part Part
 * @{
 ******************************************************************************/
...
#define _SILICON_LABS_32B_SERIES_1_CONFIG_4                                     /**< Series 1, Configuration 4 */
#define _SILICON_LABS_32B_SERIES_1_CONFIG       4                               /**< Series 1, Configuration 4 */
#define _SILICON_LABS_GECKO_INTERNAL_SDID       95                              /**< Silicon Labs internal use only, may change any time */
#define _SILICON_LABS_GECKO_INTERNAL_SDID_95                                    /**< Silicon Labs internal use only, may change any time */
...
#if !defined(EFR32FG14P232F128GM48)
#define EFR32FG14P232F128GM48    1 /**< FLEX Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER                "EFR32FG14P232F128GM48" /**< Part Number */

/** Memory Base addresses and limits */
#define RAM1_MEM_BASE              (0x20004000UL)          /**< RAM1 base address  */
#define RAM1_MEM_SIZE              (0x4000UL)              /**< RAM1 available address space  */
#define RAM1_MEM_END               (0x20007FFFUL)          /**< RAM1 end address  */
#define RAM1_MEM_BITS              (0x0000000EUL)          /**< RAM1 used bits  */
#define RAM2_MEM_BASE              (0x20008000UL)          /**< RAM2 base address  */
#define RAM2_MEM_SIZE              (0x800UL)               /**< RAM2 available address space  */
#define RAM2_MEM_END               (0x200087FFUL)          /**< RAM2 end address  */
...
#define RAM1_CODE_MEM_BASE         (0x10004000UL)          /**< RAM1_CODE base address  */
#define RAM1_CODE_MEM_SIZE         (0x4000UL)              /**< RAM1_CODE available address space  */
#define RAM1_CODE_MEM_END          (0x10007FFFUL)          /**< RAM1_CODE end address  */
#define RAM1_CODE_MEM_BITS         (0x0000000EUL)          /**< RAM1_CODE used bits  */
#define RAM0_CODE_MEM_BASE         (0x10000000UL)          /**< RAM0_CODE base address  */
#define RAM0_CODE_MEM_SIZE         (0x4000UL)              /**< RAM0_CODE available address space  */
#define RAM0_CODE_MEM_END          (0x10003FFFUL)          /**< RAM0_CODE end address  */
#define RAM0_CODE_MEM_BITS         (0x0000000EUL)          /**< RAM0_CODE used bits  */
...
#define RAM_MEM_SIZE               (0x4000UL)              /**< RAM available address space  */
#define RAM_MEM_END                (0x20003FFFUL)          /**< RAM end address  */
#define RAM_MEM_BITS               (0x0000000EUL)          /**< RAM used bits  */
...
#define RAM2_CODE_MEM_BASE         (0x10008000UL)          /**< RAM2_CODE base address  */
#define RAM2_CODE_MEM_SIZE         (0x800UL)               /**< RAM2_CODE available address space  */
#define RAM2_CODE_MEM_END          (0x100087FFUL)          /**< RAM2_CODE end address  */
...
/** Flash and SRAM limits for EFR32FG14P232F128GM48 */
...
#define EXT_IRQ_COUNT              42             /**< Number of External (NVIC) interrupts */
...
#include "system_efr32fg14p.h"  /* System Header File */

/** @} End of group EFR32FG14P232F128GM48_Part */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 ******************************************************************************/

#include "efr32fg14p_msc.h"
#include "efr32fg14p_emu.h"
#include "efr32fg14p_rmu.h"
#include "efr32fg14p_cmu.h"
#include "efr32fg14p_crypto.h"
#include "efr32fg14p_gpio_p.h"
#include "efr32fg14p_gpio.h"
#include "efr32fg14p_prs_ch.h"
#include "efr32fg14p_prs.h"
#include "efr32fg14p_ldma_ch.h"
#include "efr32fg14p_ldma.h"
#include "efr32fg14p_fpueh.h"
#include "efr32fg14p_gpcrc.h"
#include "efr32fg14p_timer_cc.h"
#include "efr32fg14p_timer.h"
#include "efr32fg14p_usart.h"
#include "efr32fg14p_leuart.h"
#include "efr32fg14p_letimer.h"
#include "efr32fg14p_cryotimer.h"
#include "efr32fg14p_pcnt.h"
#include "efr32fg14p_i2c.h"
#include "efr32fg14p_adc.h"
#include "efr32fg14p_acmp.h"
#include "efr32fg14p_vdac_opa.h"
#include "efr32fg14p_vdac.h"
#include "efr32fg14p_lesense_st.h"
#include "efr32fg14p_lesense_buf.h"
#include "efr32fg14p_lesense_ch.h"
#include "efr32fg14p_lesense.h"
#include "efr32fg14p_rtcc_cc.h"
#include "efr32fg14p_rtcc_ret.h"
#include "efr32fg14p_rtcc.h"
#include "efr32fg14p_rtc_comp.h"
#include "efr32fg14p_rtc.h"
#include "efr32fg14p_wdog_pch.h"
#include "efr32fg14p_wdog.h"
#include "efr32fg14p_idac.h"
#include "efr32fg14p_smu.h"
#include "efr32fg14p_trng.h"
#include "efr32fg14p_dma_descriptor.h"
#include "efr32fg14p_devinfo.h"
#include "efr32fg14p_romtable.h"

/** @} End of group EFR32FG14P232F128GM48_Peripheral_TypeDefs  */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_Peripheral_Base Peripheral Memory Map
 * @{
 ******************************************************************************/
...
/** @} End of group EFR32FG14P232F128GM48_Peripheral_Base */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_Peripheral_Declaration Peripheral Declarations
 * @{
 ******************************************************************************/
...
/** @} End of group EFR32FG14P232F128GM48_Peripheral_Declaration */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_Peripheral_Offsets Peripheral Offsets
 * @{
 ******************************************************************************/
...
/** @} End of group EFR32FG14P232F128GM48_Peripheral_Offsets */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_BitFields Bit Fields
 * @{
 ******************************************************************************/

#include "efr32fg14p_prs_signals.h"
#include "efr32fg14p_dmareq.h"

/***************************************************************************//**
 * @addtogroup EFR32FG14P232F128GM48_WTIMER
 * @{
 * @defgroup EFR32FG14P232F128GM48_WTIMER_BitFields  WTIMER Bit Fields
 * @{
 ******************************************************************************/
...
/** @} */
/** @} End of group EFR32FG14P232F128GM48_WTIMER */

/***************************************************************************//**
 * @addtogroup EFR32FG14P232F128GM48_PRORTC
 * @{
 * @defgroup EFR32FG14P232F128GM48_PRORTC_BitFields  PRORTC Bit Fields
 * @{
 ******************************************************************************/
...
/** @} */
/** @} End of group EFR32FG14P232F128GM48_PRORTC */

/***************************************************************************//**
 * @defgroup EFR32FG14P232F128GM48_UNLOCK Unlock Codes
 * @{
 ******************************************************************************/
...
/** @} End of group EFR32FG14P232F128GM48_UNLOCK */

/** @} End of group EFR32FG14P232F128GM48_BitFields */

#include "efr32fg14p_af_ports.h"
#include "efr32fg14p_af_pins.h"

/** @} End of group EFR32FG14P232F128GM48 */
