...
# Post Build processing for IAR Workbench.
...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/home/ubuntu/SimplicityStudio_v4/developer/toolchains/gnu_arm/4.9_2015q3/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print " "
    EBL_COMMAND = START_FLAGS + shortPath(r"/home/ubuntu/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device EFR32MG1P232F256GM48 " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/home/ubuntu/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device EFR32MG1P232F256GM48"
